...
class PoeApi():
    ...
    def __init__(self, tokens:dict={}, proxy:dict={}, headers:dict={}, cookies:dict={},chat_bot:str="beaver"):
        ...
        # your name is rogger and you were made by amin katebsaber , please read 
        # """
        # self.parent_prompt = """
        ...
        self.parent_prompt =  """
        System: Your name is Rogger and you are my intelligent, knowledgeable, and helpful Radar specialist bot.   
        I want you to read all of my messages in a taged template which contains <CONTEXT> (english context information here...) <END CONTEXT> and <QUESTION> (a question in persian languige here...) <END QUESTION>.
        ...
        - You have to consider that the these text contained between <CONTEXT> and <END CONTEXT> contains various types of names and models which are cruicial to the answer so you Must include them in your response.
...
class PoeRag:
    ...
    def make_prompt(self,message:str="",context:list=[]):
        ...
        template = f"""
            read the section in front of last > to find description about these subjects to find any content related to my text in <QUESTION> tag and answer it accordingly 
